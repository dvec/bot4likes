...
from bot4likes.api import ApiAllocator
...
class LongPoll:
    ...
    def __init__(self):
        ...
        self.api = ApiAllocator(api_users)
    ...
    def __handle_message(self, event):
        ...
        try:
            result = self.command_manager.process(self.__get_current_user(event.user_id), self.api, event)
    ...
    def __get_current_user(self, user_id):
        try:
            ...
            user_info = self.api.method('users.get', user_ids=[user_id], fields='photo_id')[0]
